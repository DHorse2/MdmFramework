...
namespace Mdm.Oss.Std
{
    ...
    /// Next: StdBaseDef
    /// </summary> 
    public class StdDef : iClassFeatures, IDisposable
    {
        #region Standard Features Common to Console and Standard Form
        public string Title;
        public string Name; // not in std form (new?)
        public int Id;
...
//public void AppendTextBox(object SenderPassed, string TextPassed, bool InvokeRequired)
        //{
        //    if (InvokeRequired)
        //    {
        //        this.Invoke(new Action<string>(AppendTextBox), new object[] { SenderPassed, TextPassed, false });
        //        return;
        //    }
        //    textBox1.Text += value;
        //}
        ...
        /// <summary>
        /// Use the constructor: StdDef(long ClassFeaturesPassed)
        /// so that correct class features will be instantiated.
        /// </summary> 
        public StdDef()
        { InitializeStd(ref Sender, ref st, ConsoleSourceIs.None, ClassRoleIs.None, ClassFeatureIs.None); }

        public StdDef(ref object SenderPassed, ref object stPassed, ConsoleSourceIs ConsoleSourcePassed, ClassRoleIs ClassRolePassed, ClassFeatureIs ClassFeaturesPassed)
        {
        ...
        public StdDef(ref object SenderPassed, ConsoleSourceIs ConsoleSourcePassed, ClassRoleIs ClassRolePassed, ClassFeatureIs ClassFeaturesPassed)
        { InitializeStd(ref SenderPassed, ref st, ConsoleSourcePassed, ClassRolePassed, ClassFeaturesPassed); }
        public StdDef(ConsoleSourceIs ConsoleSourcePassed, ClassRoleIs ClassRolePassed, ClassFeatureIs ClassFeaturesPassed)
        { InitializeStd(ref Sender, ref st, ConsoleSourcePassed, ClassRolePassed, ClassFeaturesPassed); }
        public StdDef(ref object SenderPassed)
        ...
        /// </param> 
        public StdDef(ref object SenderPassed, ref object stPassed)
        {
            FeaturesExtract(stPassed);
        ...
        public virtual void FeaturesExtract(object stPassed)
        {
            ...
            {
                ConsoleSource = ((iClassFeatures)ConsoleSender).ConsoleSourceGet();
        ...
        public virtual void InitializeStd(ref object SenderPassed, ref object stPassed, ConsoleSourceIs ConsoleSourcePassed, ClassRoleIs ClassRolePassed, ClassFeatureIs ClassFeaturesPassed)
        {
            ...
            if (ConsoleSender == null)
            {
                ...
                #region Form
                iStdBaseForm SenderLocal = Sender as iStdBaseForm;
                if (Sender != null)
                {
                    if (FormParent == null)
                    {
                    ...
                    else if (FormChildObject == null
                           && SenderLocal.KeyGet().Key != FormParent.KeyGet().Key)
                    {
                        if (Sender is iStdBaseForm)
                        {
            ...
            if (ConsoleSender != null)
            {
                ...
                if (StdRunControlUi == null)
                {
                    ...
                    if (StdRunControlUi == null && ConsoleSender != this)
                    {
                        StdRunControlUi = ((iClassFeatures)ConsoleSender).StdRunControlUiGet();
                    }
                    //
            ...
            #endregion
            #region Notify Group
            if (StdNotify == null && StdNotify != null)
            {
                if (ConsoleSender == null  
            ...
            switch (ConsoleSource)
            {
                case (ConsoleSourceIs.Self):
                    ...
                    // ConsoleSetFrom(ref SenderPassed);
                    break;
        ...
        public virtual void InitializeStdX(ref object SenderPassed, ref object stPassed, ConsoleSourceIs ConsoleSourcePassed, ClassRoleIs ClassRolePassed, ClassFeatureIs ClassFeaturesPassed)
        {
            ...
            if (SenderPassed != null)
            {
                ...
                {
                    //st = stPassed;
                    st = ((iClassFeatures)SenderPassed).ConsoleGetTo(ref st);
                    ConsoleSender = st;
                    StdProcess = ((iClassFeatures)SenderPassed).StdProcessGet();
                    StdRunControlUi = ((iClassFeatures)SenderPassed).StdRunControlUiGet();
                }
            }
            else
            {
            ...
            if (st == null)
            {
                st = this; ConsoleSender = this;
            }
            //
            if (StdRunControlUi == null) { StdRunControlUi = new StdBaseRunControlUiDef(ref Sender, ref st, StdKey); }
            //
            // This is default program control of Forms
            if (Sender is iStdBaseForm)
            {
        ...
        //}
        protected FileType_LevelIs zFileLevelId;
        ...
        #region FileType
        protected FileType_Is zFileTypeId;
        ...
        #endregion
        #region FileSubType
        protected FileType_SubTypeIs zFileSubTypeId;
        ...
        public virtual StateIs StdRunControlSetFrom(
            ref StdBaseRunControlUiDef StdRunControlUiPassed)
        {
            if (StdRunControlUi != null)
            {
