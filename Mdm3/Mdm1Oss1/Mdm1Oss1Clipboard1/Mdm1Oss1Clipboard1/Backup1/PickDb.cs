...
namespace Mdm.Pick.File {
    public class MfilePickDb : Mfile {
        ...
        public long PickItemDataCounterGet(ref FileMainDef FmainPassed) {
            ...
            //
            if (TraceOn || ConsoleOn || ConsoleBasicOn) { TraceMdmDoImpl(ref Sender, bIsMessage, TraceMdmCounterLevel1GetDefault(), TraceMdmCounterLevel2GetDefault(), PickItemDataCounterResult, ErrorDidNotOccur, iNoErrorLevel, iNoErrorSource, bDoNotDisplay, MessageNoUserEntry, "A2" + "Count Current Column Attrs: " + FmainPassed.ColIndex.ColMaxIndexTemp.ToString() + "\n"); }
            // 
            ...
            if (TraceOn || ConsoleOn || ConsoleBasicOn) { TraceMdmDoImpl(ref Sender, bIsMessage, TraceMdmCounterLevel1GetDefault(), TraceMdmCounterLevel2GetDefault(),PickItemDataCounterResult, ErrorDidNotOccur, iNoErrorLevel, iNoErrorSource, bDoNotDisplay, MessageNoUserEntry, "A2" + "Current Column Last Character Location: " + FmainPassed.DelSep.iItemDataCharEobIndex.ToString() + "\n"); }
            //
        ...
        public long PickIdCheckOptions(ref FileMainDef FmainPassed) {
            ...
            if (LocalId.LongResult != 0) {
                if ((PickIndex(RunOptions, "O", 1)) == 0) {
                    ...
                    TraceMdmDoImpl(ref Sender, bIsMessage, TraceMdmCounterLevel1GetDefault(), TraceMdmCounterLevel2GetDefault(),PickSystemCallStringResult, RunErrorDidOccur = true, iNoErrorLevel, iNoErrorSource, bDoNotDisplay, MessageNoUserEntry, "A2" + LocalMessage.Msg6 + "\n");
                    // goto finish;
            ...
            if (sTemp5.Length > 0) {
                ...
                if (TraceBugOnNow) {
                    if (FmainPassed.ColIndex.ColText.Length > 100) {
                        ...
                        TraceMdmDoImpl(ref Sender, bIsMessage, TraceMdmCounterLevel1GetDefault(), TraceMdmCounterLevel2GetDefault(),PickIdGetResult, TraceBugOnNow, iNoErrorLevel, iNoErrorSource, bDoNotDisplay, MessageNoUserEntry, LocalMessage.Msg9);
        ...
        public long PickIdChanged(ref FileMainDef FmainPassed, String ItemIdCurrent) {
            ...
            if (!IterationFirst) {
                if (FmainPassed.Item.ItemId.Length > 0 && FmainPassed.Item.ItemData.Length > 0) {
                    ...
                    if (ConsoleOn) {
                        ...
                        LocalMessage.Msg6 += ", Id length: (" + FmainPassed.Item.ItemId.Length.ToString() + ")";
                        // PrintOutputMdm_PickPrint(Sender, 3, "A2" + LocalMessage.Msg6, bYES);
                        TraceMdmDoImpl(ref Sender, bIsMessage, TraceMdmCounterLevel1GetDefault(), TraceMdmCounterLevel2GetDefault(),PickIdGetResult, TraceBugOnNow, iNoErrorLevel, iNoErrorSource, bDoNotDisplay, MessageNoUserEntry, "A2" + LocalMessage.Msg6 + "\n");
                    }
                    //
            ...
            if (TraceBugOnNow && iTraceDisplayCountTotal > iTraceBugThreshold) {
                ...
                TraceMdmDoImpl(ref Sender, bIsMessage, TraceMdmCounterLevel1GetDefault(), TraceMdmCounterLevel2GetDefault(),PickIdChangedResult, ErrorDidNotOccur, iNoErrorLevel, iNoErrorSource, bDoNotDisplay, MessageNoUserEntry, "A2" + LocalMessage.Msg6 + "\n");
            }
            //
