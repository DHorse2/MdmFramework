...
namespace Mdm.Oss.Sys.Binder {

    class Mbinder : System.Reflection.Binder {
    ...
    public class Binder_Example {
        public static void Main() {
            ...
            // Invoke MyMethod.
            myMethod.Invoke(myInstance, BindingFlags.InvokeMethod, new Mbinder(), new Object[] { (int)32, (int)32 }, CultureInfo.CurrentCulture);
        }
    }
}
