...
namespace Mdm.Oss.WinUtil {
    ...
    /// <summary>
    /// <para> The delegate matches the signature for
    /// the WinProc function.</para>
    /// </summary>
    public delegate int WindowProcDelegate(IntPtr hw, IntPtr uMsg, IntPtr wParam, IntPtr lParam);

	/// <summary>
	/// COM functions that deal with messages.
	/// </summary>
    public class Win32MsgDef
    {
    ...
    /// <summary>
    /// _a_MdmOssWinUtil_ReadMe 
    /// </summary>
    public enum _a_MdmOssWinUtil_ReadMe : long { ThisIsNotUsed = 0xF }

	/// <summary>
	/// Windows Event MessageTypeIs sent to the WindowProc
	/// </summary>
	public enum MsgTypeIs : int {
		WM_NULL                   = 0x0000,
		WM_CREATE                 = 0x0001,
		WM_DESTROY                = 0x0002,
		WM_MOVE                   = 0x0003,
