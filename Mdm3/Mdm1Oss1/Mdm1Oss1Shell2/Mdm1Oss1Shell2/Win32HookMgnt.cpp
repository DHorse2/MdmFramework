...
namespace Mdm {
    namespace Oss {
        namespace WinUtil {
            ...
            Win32Hook::Win32Hook(void){
                hwndMain = NULL;
                // HookDataArr = gcnew array<HookDataDef ^>(NUMHOOKS);
                HookIndex = 0; 
            };

            LRESULT WINAPI Win32Hook::MainWndProc(
                HWND hwndMainPassed, 
                UINT uMsg, 
                WPARAM wParam, 
                LPARAM lParam) 
            ...
            ****************************************************************/ 
            LRESULT Win32Hook::CallWndProc(int nCode, WPARAM wParam, LPARAM lParam) 
            { 
                // CHAR szCWPBuf[256]; 
            ...
            ****************************************************************/ 
            ...
            LRESULT CALLBACK Win32Hook::GetMsgProc(int nCode, WPARAM wParam, LPARAM lParam) 
            { 
                // CHAR szMSGBuf[256]; 
            ...
            ****************************************************************/ 
            ...
            LRESULT CALLBACK Win32Hook::DebugProc(int nCode, WPARAM wParam, LPARAM lParam) 
            { 
                // CHAR szBuf[128]; 
            ...
            ****************************************************************/ 
            ...
            LRESULT CALLBACK Win32Hook::CBTProc(int nCode, WPARAM wParam, LPARAM lParam) 
            { 
                // CHAR szBuf[128]; 
                STRSAFE_LPWSTR szBuf;
                // CHAR szCode[128]; 
            ...
            ****************************************************************/ 
            ...
            LRESULT CALLBACK Win32Hook::MouseProc(int nCode, WPARAM wParam, LPARAM lParam) 
            { 
                // CHAR szBuf[128]; 
                STRSAFE_LPWSTR szBuf;
                // CHAR szMsg[16]; 
            ...
            ****************************************************************/ 
            ...
            LRESULT CALLBACK Win32Hook::KeyboardProc(int nCode, WPARAM wParam, LPARAM lParam) 
            { 
                // CHAR szBuf[128]; 
                STRSAFE_LPWSTR szBuf;
                HDC hdc; 
            ...
            ****************************************************************/ 
            ...
            LRESULT CALLBACK Win32Hook::MessageProc(int nCode, WPARAM wParam, LPARAM lParam) 
            { 
                // CHAR szBuf[128]; 
                STRSAFE_LPWSTR szBuf;
                // CHAR szMsg[16]; 
            ...
            VOID Win32Hook::LookUpTheMessage(PMSG lParam, STRSAFE_LPWSTR szMsg) {
