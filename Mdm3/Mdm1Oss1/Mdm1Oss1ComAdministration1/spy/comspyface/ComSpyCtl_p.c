...
typedef struct _ComSpyCtl_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ComSpyCtl_MIDL_TYPE_FORMAT_STRING;

typedef struct _ComSpyCtl_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ComSpyCtl_MIDL_PROC_FORMAT_STRING;

typedef struct _ComSpyCtl_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ComSpyCtl_MIDL_EXPR_FORMAT_STRING;
...
extern const ComSpyCtl_MIDL_TYPE_FORMAT_STRING ComSpyCtl__MIDL_TypeFormatString;
extern const ComSpyCtl_MIDL_PROC_FORMAT_STRING ComSpyCtl__MIDL_ProcFormatString;
extern const ComSpyCtl_MIDL_EXPR_FORMAT_STRING ComSpyCtl__MIDL_ExprFormatString;
...
static const ComSpyCtl_MIDL_PROC_FORMAT_STRING ComSpyCtl__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ComSpyCtl_MIDL_TYPE_FORMAT_STRING ComSpyCtl__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_ComSpyCtl_0000_0000, ver. 0.0,
...
static const MIDL_STUBLESS_PROXY_INFO IComSpy_ProxyInfo =
    {
    &Object_StubDesc,
    ComSpyCtl__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ComSpyCtl__MIDL_TypeFormatString.Format,
