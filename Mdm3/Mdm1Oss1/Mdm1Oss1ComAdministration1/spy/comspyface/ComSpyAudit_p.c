...
typedef struct _ComSpyAudit_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ComSpyAudit_MIDL_TYPE_FORMAT_STRING;

typedef struct _ComSpyAudit_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ComSpyAudit_MIDL_PROC_FORMAT_STRING;

typedef struct _ComSpyAudit_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ComSpyAudit_MIDL_EXPR_FORMAT_STRING;
...
extern const ComSpyAudit_MIDL_TYPE_FORMAT_STRING ComSpyAudit__MIDL_TypeFormatString;
extern const ComSpyAudit_MIDL_PROC_FORMAT_STRING ComSpyAudit__MIDL_ProcFormatString;
extern const ComSpyAudit_MIDL_EXPR_FORMAT_STRING ComSpyAudit__MIDL_ExprFormatString;
...
static const ComSpyAudit_MIDL_PROC_FORMAT_STRING ComSpyAudit__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ComSpyAudit_MIDL_TYPE_FORMAT_STRING ComSpyAudit__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComSpyAudit_ProxyInfo =
    {
    &Object_StubDesc,
    ComSpyAudit__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ComSpyAudit__MIDL_TypeFormatString.Format,
